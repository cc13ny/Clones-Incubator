...
ActiveRecord::Schema.define(version: 20180417152711) do

  create_table "task_dependencies", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer  "task_id"
    t.integer  "sub_task_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["sub_task_id"], name: "index_task_dependencies_on_sub_task_id", using: :btree
    t.index ["task_id"], name: "index_task_dependencies_on_task_id", using: :btree
  end
